...
const album1 = {
  ...
  album3.albumDetails.released = Date.parse('August 3, 1979');
  ...
  // Exercise 8:  Using the talkingHeadsAlbums array, assign album5's labels property to a variable named labels
      // not sure qhar the question is asking here maybe
  ...
  //talkingHeadsAlbums array at the index represented by the value of albumIdx to a variable named albumDetails
